(function (global, factory) {
	...
	(factory((global.funfixEffect = {}),global.funfixCore));
...
var IO = function () {
    ...
    createClass(IO, [{
        ...
        value: function doOnFinish(f) {
            return this.transformWith(function (e) {
                return f(funfixCore.Some(e)).flatMap(function (_) {
                    return IO.raise(e);
                });
            }, function (a) {
                return f(funfixCore.None).map(function (_) {
                    return a;
                });
            });
        }
        ...
        key: "timeout",
        value: function timeout(after) {
            var fb = IO.raise(new funfixCore.TimeoutError(Duration.of(after).toString()));

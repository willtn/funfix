 ...
 */
export declare type TypeClass<F> = Constructor<F> & {
 ...
 */
export declare function registerTypeClassInstance<F>(tc: TypeClass<F>): <T>(c: Constructor<T>, instance: F) => void;
/**
 ...
 * ```
 */
export declare function getTypeClassInstance<F>(tc: TypeClass<F>): <T>(c: Constructor<T>) => F;

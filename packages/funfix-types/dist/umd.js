(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('funfix-core'), require('funfix-effect'), require('funfix-exec')) :
	typeof define === 'function' && define.amd ? define(['exports', 'funfix-core', 'funfix-effect', 'funfix-exec'], factory) :
	(factory((global.funfixTypes = {}),global.funfixCore,global.funfixEffect,global.funfixExec));
}(this, (function (exports,funfixCore,funfixEffect,funfixExec) { 'use strict';
...
function registerTypeClassInstance(tc) {
    return function (c, instance) {
        ...
        if (existing) {
            ...
            throw new funfixCore.IllegalArgumentError("Type class coherence issue, " + (name + "<" + c.name + "> is already defined!"));
        }
...
function getTypeClassInstance(tc) {
    return function (c) {
        ...
        throw new funfixCore.NotImplementedError(tc.name + "<" + obj.name + ">");
    };
}
...
var FunctorLaws = function () {
  ...
  createClass(FunctorLaws, [{
    ...
    value: function covariantIdentity(fa) {
      return Equiv.of(this.F.map(fa, funfixCore.id), fa);
    }
  }, {
...
funfixCore.applyMixins(Apply, [Functor]);
...
funfixCore.applyMixins(ApplyLaws, [FunctorLaws]);
...
funfixCore.applyMixins(Applicative, [Apply]);
...
funfixCore.applyMixins(ApplicativeLaws, [ApplyLaws]);
    ...
    createClass(ApplicativeError, [{
        ...
        value: function attempt(fa) {
            ...
            return F.recover(F.map(fa, function (a) {
                return funfixCore.Either.right(a);
            }), funfixCore.Left);
        }
    }]);
...
funfixCore.applyMixins(ApplicativeError, [Applicative]);
...
var ApplicativeErrorLaws = function () {
    ...
    createClass(ApplicativeErrorLaws, [{
        ...
        value: function raiseErrorAttempt(e) {
            var F = this.F;
            return Equiv.of(F.attempt(F.raise(e)), F.pure(funfixCore.Left(e)));
        }
    }, {
        key: "pureAttempt",
        value: function pureAttempt(a) {
            var F = this.F;
            return Equiv.of(F.attempt(F.pure(a)), F.pure(funfixCore.Right(a)));
        }
    }]);
    return ApplicativeErrorLaws;
}();
funfixCore.applyMixins(ApplicativeErrorLaws, [ApplicativeLaws]);
            ...
            var bounce = function bounce(n) {
                return F.tailRecM([a, n], function (x) {
                    ...
                    return i > 0 ? F.map(f(a0), function (a1) {
                        return funfixCore.Left([a1, i - 1]);
                    }) : F.map(f(a0), funfixCore.Right);
                });
            };
...
funfixCore.applyMixins(FlatMapLaws, [ApplyLaws]);
...
funfixCore.applyMixins(Monad, [Applicative, FlatMap]);
    ...
    createClass(MonadLaws, [{
        ...
        value: function tailRecMStackSafety() {
            ...
            var res = F.tailRecM(0, function (i) {
                return F.pure(i < n ? funfixCore.Left(i + 1) : funfixCore.Right(i));
            });
...
funfixCore.applyMixins(MonadLaws, [ApplicativeLaws, FlatMapLaws]);
...
funfixCore.applyMixins(MonadError, [Monad, ApplicativeError]);
...
funfixCore.applyMixins(MonadErrorLaws, [MonadLaws, ApplicativeErrorLaws]);
...
funfixCore.applyMixins(CoflatMap, [Functor]);
...
var CoflatMapLaws = function () {
  ...
  createClass(CoflatMapLaws, [{
    ...
    value: function coflatMapIdentity(fa) {
      var F = this.F;
      return Equiv.of(F.coflatten(fa), F.coflatMap(fa, funfixCore.id));
    }
  }]);
  return CoflatMapLaws;
}();
funfixCore.applyMixins(CoflatMapLaws, [FunctorLaws]);
...
funfixCore.applyMixins(Comonad, [CoflatMap]);
...
funfixCore.applyMixins(ComonadLaws, [CoflatMapLaws]);
...
var OptionInstances = function () {
    function OptionInstances() {
        ...
        this.__unit = funfixCore.Some(undefined);
    }
    ...
    createClass(OptionInstances, [{
        ...
        key: "ap",
        value: function ap(fa, ff) {
            return funfixCore.Option.map2(fa, ff, function (a, f) {
                return f(a);
            });
        }
    }, {
        ...
        key: "map2",
        value: function map2(fa, fb, f) {
            return funfixCore.Option.map2(fa, fb, f);
        }
    }, {
        key: "product",
        value: function product(fa, fb) {
            return funfixCore.Option.map2(fa, fb, function (a, b) {
                return [a, b];
            });
        }
    }, {
        ...
        value: function tailRecM(a, f) {
            return funfixCore.Option.tailRecM(a, f);
        }
    }, {
        key: "coflatMap",
        value: function coflatMap(fa, ff) {
            return funfixCore.Some(ff(fa));
        }
    }, {
        key: "coflatten",
        value: function coflatten(fa) {
            return funfixCore.Some(fa);
        }
    }]);
...
funfixCore.applyMixins(OptionInstances, [Monad]);

registerTypeClassInstance(Eq)(funfixCore.Option, OptionInstances.global);
registerTypeClassInstance(Monad)(funfixCore.Option, OptionInstances.global);
registerTypeClassInstance(CoflatMap)(funfixCore.Option, OptionInstances.global);
...
var TryInstances = function () {
    ...
    createClass(TryInstances, [{
        ...
        key: "pure",
        value: function pure(a) {
            return funfixCore.Success(a);
        }
    }, {
        key: "unit",
        value: function unit() {
            return funfixCore.Try.unit();
        }
    }, {
        key: "ap",
        value: function ap(fa, ff) {
            return funfixCore.Try.map2(fa, ff, function (a, f) {
                return f(a);
            });
        }
    }, {
        ...
        key: "map2",
        value: function map2(fa, fb, f) {
            return funfixCore.Try.map2(fa, fb, f);
        }
    }, {
        key: "product",
        value: function product(fa, fb) {
            return funfixCore.Try.map2(fa, fb, function (a, b) {
                return [a, b];
            });
        }
    }, {
        ...
        key: "tailRecM",
        value: function tailRecM(a, f) {
            return funfixCore.Try.tailRecM(a, f);
        }
    }, {
        key: "raise",
        value: function raise(e) {
            return funfixCore.Try.failure(e);
        }
    }, {
        key: "attempt",
        value: function attempt(fa) {
            return funfixCore.Try.success(fa.fold(function (e) {
                return funfixCore.Either.left(e);
        ...
        key: "coflatMap",
        value: function coflatMap(fa, ff) {
            return funfixCore.Success(ff(fa));
        }
    }, {
        key: "coflatten",
        value: function coflatten(fa) {
            return funfixCore.Success(fa);
        }
    }]);
    return TryInstances;
}();
...
funfixCore.applyMixins(TryInstances, [MonadError]);

registerTypeClassInstance(Eq)(funfixCore.Try, TryInstances.global);
registerTypeClassInstance(MonadError)(funfixCore.Try, TryInstances.global);
registerTypeClassInstance(CoflatMap)(funfixCore.Try, TryInstances.global);

var EitherInstances = function () {
    function EitherInstances() {
        classCallCheck(this, EitherInstances);

        this.__unit = funfixCore.Right(undefined);
    }
    ...
    createClass(EitherInstances, [{
        ...
        value: function ap(fa, ff) {
            var faE = fa;
            var ffE = ff;
            return funfixCore.Either.map2(faE, ffE, function (a, f) {
                return f(a);
            });
        }
    }, {
        ...
        key: "map2",
        value: function map2(fa, fb, f) {
            return funfixCore.Either.map2(fa, fb, f);
        }
    }, {
        key: "product",
        value: function product(fa, fb) {
            return funfixCore.Either.map2(fa, fb, function (a, b) {
                return [a, b];
            });
        }
    }, {
        ...
        key: "tailRecM",
        value: function tailRecM(a, f) {
            return funfixCore.Either.tailRecM(a, f);
        }
    }, {
        key: "coflatMap",
        value: function coflatMap(fa, ff) {
            return funfixCore.Right(ff(fa));
        }
    }, {
        key: "coflatten",
        value: function coflatten(fa) {
            return funfixCore.Right(fa);
        }
    }]);
...
funfixCore.applyMixins(EitherInstances, [Monad]);

registerTypeClassInstance(Eq)(funfixCore.Either, EitherInstances.global);
registerTypeClassInstance(Monad)(funfixCore.Either, EitherInstances.global);
registerTypeClassInstance(CoflatMap)(funfixCore.Either, EitherInstances.global);
...
var EvalInstances = function () {
    ...
    createClass(EvalInstances, [{
        key: "pure",
        value: function pure(a) {
            return funfixEffect.Eval.now(a);
        }
    }, {
        key: "flatMap",
        value: function flatMap(fa, f) {
        ...
        key: "tailRecM",
        value: function tailRecM(a, f) {
            return funfixEffect.Eval.tailRecM(a, f);
        }
    }, {
        key: "ap",
        value: function ap(fa, ff) {
        ...
        key: "unit",
        value: function unit() {
            return funfixEffect.Eval.unit();
        }
    }, {
        key: "coflatMap",
        value: function coflatMap(fa, ff) {
            return funfixEffect.Eval.now(ff(fa));
        }
    }, {
        key: "coflatten",
        value: function coflatten(fa) {
            return funfixEffect.Eval.now(fa);
        }
    }, {
        key: "extract",
...
funfixCore.applyMixins(EvalInstances, [Monad, Comonad]);

registerTypeClassInstance(Monad)(funfixEffect.Eval, EvalInstances.global);
registerTypeClassInstance(Comonad)(funfixEffect.Eval, EvalInstances.global);
...
var FutureInstances = function () {
    ...
    createClass(FutureInstances, [{
        key: "pure",
        value: function pure(a) {
            return funfixExec.Future.pure(a);
        }
    }, {
        key: "flatMap",
        value: function flatMap(fa, f) {
        ...
        key: "tailRecM",
        value: function tailRecM(a, f) {
            return funfixExec.Future.tailRecM(a, f);
        }
    }, {
        key: "ap",
        value: function ap(fa, ff) {
        ...
        key: "unit",
        value: function unit() {
            return funfixExec.Future.unit();
        }
    }, {
        key: "raise",
        value: function raise(e) {
            return funfixExec.Future.raise(e);
        }
    }, {
        key: "attempt",
        value: function attempt(fa) {
        ...
        key: "map2",
        value: function map2(fa, fb, f) {
            return funfixExec.Future.map2(fa, fb, f);
        }
    }, {
        key: "coflatMap",
        value: function coflatMap(fa, ff) {
            return funfixExec.Future.pure(ff(fa));
        }
    }, {
        key: "coflatten",
        value: function coflatten(fa) {
            return funfixExec.Future.pure(fa);
        }
    }]);
...
funfixCore.applyMixins(FutureInstances, [MonadError, CoflatMap]);

registerTypeClassInstance(MonadError)(funfixExec.Future, FutureInstances.global);
registerTypeClassInstance(CoflatMap)(funfixExec.Future, FutureInstances.global);
...
var IOInstances = function () {
    ...
    createClass(IOInstances, [{
        ...
        key: "tailRecM",
        value: function tailRecM(a, f) {
            return funfixEffect.IO.tailRecM(a, f);
        }
    }, {
        key: "ap",
        value: function ap(fa, ff) {
        ...
        key: "unit",
        value: function unit() {
            return funfixEffect.IO.unit();
        }
    }, {
        key: "raise",
        value: function raise(e) {
            return funfixEffect.IO.raise(e);
        }
    }, {
        key: "attempt",
        value: function attempt(fa) {
        ...
        key: "map2",
        value: function map2(fa, fb, f) {
            return funfixEffect.IO.map2(fa, fb, f);
        }
    }, {
        key: "followedBy",
        value: function followedBy(fa, fb) {
        ...
        key: "followedByL",
        value: function followedByL(fa, fb) {
            return fa.followedBy(funfixEffect.IO.suspend(fb));
        }
    }, {
        key: "forEffect",
        value: function forEffect(fa, fb) {
        ...
        key: "forEffectL",
        value: function forEffectL(fa, fb) {
            return fa.forEffect(funfixEffect.IO.suspend(fb));
        }
    }, {
        key: "product",
        value: function product(fa, fb) {
            return funfixEffect.IO.map2(fa, fb, function (a, b) {
                return [a, b];
            });
        }
    }, {
        key: "coflatMap",
        value: function coflatMap(fa, ff) {
            return funfixEffect.IO.pure(ff(fa));
        }
    }, {
        key: "coflatten",
        value: function coflatten(fa) {
            return funfixEffect.IO.pure(fa);
        }
    }]);
    return IOInstances;
}();
...
funfixCore.applyMixins(IOInstances, [MonadError, CoflatMap]);

registerTypeClassInstance(MonadError)(funfixEffect.IO, IOInstances.global);
registerTypeClassInstance(CoflatMap)(funfixEffect.IO, IOInstances.global);

...
import { Apply, ApplyLaws, Applicative, ApplicativeLaws, ApplicativeError, ApplicativeErrorLaws } from "./applicative";
/**
 ...
 */
export declare abstract class FlatMap<F> implements Apply<F> {
 ...
 * default implementations and not classes.
 */
export declare abstract class FlatMapLaws<F> implements ApplyLaws<F> {
    /**
     * The {@link Apply} designated instance for `F`,
     * to be tested.
     */
    readonly F: FlatMap<F>;
    /**
     * ```typescript
 ...
 * ```
 */
export declare const flatMapOf: <F>(c: Constructor<F>) => FlatMap<F>;
/**
 * Given an {@link FlatMap} instance, returns the {@link FlatMapLaws}
 * associated with it.
 */
export declare function flatMapLawsOf<F>(instance: FlatMap<F>): FlatMapLaws<F>;
/**
 ...
 * [Typelevel Cats]{@link http://typelevel.org/cats/} project.
 */
export declare abstract class Monad<F> implements FlatMap<F>, Applicative<F> {
 ...
 * default implementations and not classes.
 */
export declare abstract class MonadLaws<F> implements ApplicativeLaws<F>, FlatMapLaws<F> {
    /**
 ...
 * ```
 */
export declare const monadOf: <F>(c: Constructor<F>) => Monad<F>;
/**
 * Given an {@link Monad} instance, returns the {@link MonadLaws}
 * associated with it.
 */
export declare function monadLawsOf<F>(instance: Monad<F>): MonadLaws<F>;
/**
 ...
 * [Typelevel Cats]{@link http://typelevel.org/cats/} project.
 */
export declare abstract class MonadError<F, E> implements ApplicativeError<F, E>, Monad<F> {
    /** Inherited from {@link Applicative.pure}. */
    abstract pure<A>(a: A): HK<F, A>;
 ...
 * default implementations and not classes.
 */
export declare abstract class MonadErrorLaws<F, E> implements ApplicativeErrorLaws<F, E>, MonadLaws<F> {
    /**
     * The {@link MonadError} designated instance for `F`,
     * to be tested.
     */
    readonly F: MonadError<F, E>;
 ...
 * ```
 */
export declare const monadErrorOf: <F, E>(c: Constructor<F>) => MonadError<F, E>;
/**
 * Given an {@link MonadError} instance, returns the
 * {@link MonadErrorLaws} associated with it.
 */
export declare function monadErrorLawsOf<F, E>(instance: MonadError<F, E>): MonadErrorLaws<F, E>;
